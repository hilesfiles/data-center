...
def validate_public_data(
    ...
    if (
        treatment_registry.get("record_count") != 3316
        or len(treatment_events) != 86
        or len(treatment_evaluations) != 86
    ...
    if (
        ...
        or assessment_status_counts != Counter({"candidate_events_not_first_entry": 86, "no_reviewed_dated_operational_event": 3058})
    ...
    for county_fips, expected in expected_treatment_evaluations.items():
        ...
        if (
            ...
            or actual.get("first_entry_verification_status") != (
                "not_verified" if county_fips in {"01069", "05145", "06055", "06095", "08001", "18089", "21071", "30017", "33015", "34017", "34039", "35049", "36047", "36085", "39017", "39045", "39165", "40013", "41005", "41047", "41051", "42003", "42077", "45051", "46099", "47157", "48475", "49047", "01071", "55133", "12031", "21111", "24003", "26045", "34013"} else "rejected_as_first_entry"
            )
    ...
    if (
        ...
        or treatment_public_index.get("adjudication_count") != 86
    ...
    if (
        ...
        or treatment_report.get("reviewed_dated_operational_event_count") != 86
        or treatment_report.get("evidence_threshold_pass_count") != 51
        or treatment_report.get("period_requirement_pass_count") != 50
        ...
        or treatment_report.get("assessment_status_counts") != {"candidate_events_not_first_entry": 86, "no_reviewed_dated_operational_event": 3058}
    ...
    if treatment_manifest.get("record_count") != 6853 or treatment_manifest_total != 6853:
    ...
    if (
        ...
        or research_tier_counts != Counter({"first_entry_deferred": 107, "first_entry_standard": 24, "first_entry_high": 86})
        ...
        or sum(record.get("dated_operational_candidate_count", 0) for record in research_candidates) != 86
    ):
    ...
    if (
        ...
        or research_report.get("priority_tier_counts") != {"first_entry_deferred": 107, "first_entry_high": 86, "first_entry_standard": 24}
        or research_report.get("initial_tranche_region_counts") != {"Midwest": 6, "Northeast": 6, "South": 6, "West": 6}
        or research_report.get("adjudication_status_counts") != {"candidate_rejected_first_entry": 51, "not_adjudicated": 131, "unresolved": 35}
