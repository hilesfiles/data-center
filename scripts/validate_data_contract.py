...
def validate_public_data(
    ...
    if (
        treatment_registry.get("record_count") != 3392
        or len(treatment_events) != 124
        or len(treatment_evaluations) != 124
    ...
    if (
        ...
        or assessment_status_counts != Counter({"candidate_events_not_first_entry": 124, "no_reviewed_dated_operational_event": 3020})
    ...
    if (
        ...
        or treatment_public_index.get("adjudication_count") != 124
    ...
    if (
        ...
        or treatment_report.get("reviewed_dated_operational_event_count") != 124
        or treatment_report.get("evidence_threshold_pass_count") != 78
        or treatment_report.get("period_requirement_pass_count") != 69
        or treatment_report.get("first_entry_verified_event_count") != 0
        or treatment_report.get("candidate_rejected_as_first_entry_count") != 51
        or treatment_report.get("eligible_treatment_event_count") != 0
        or treatment_report.get("eligible_county_count") != 0
        or treatment_report.get("assessment_status_counts") != {"candidate_events_not_first_entry": 124, "no_reviewed_dated_operational_event": 3020}
    ...
    if treatment_manifest.get("record_count") != 7042 or treatment_manifest_total != 7042:
    ...
    if (
        ...
        or research_tier_counts != Counter({"first_entry_deferred": 69, "first_entry_standard": 24, "first_entry_high": 124})
        ...
        or sum(record.get("dated_operational_candidate_count", 0) for record in research_candidates) != 124
    ):
    ...
    if (
        ...
        or research_report.get("priority_tier_counts") != {"first_entry_deferred": 69, "first_entry_high": 124, "first_entry_standard": 24}
        or research_report.get("initial_tranche_region_counts") != {"Midwest": 6, "Northeast": 6, "South": 6, "West": 6}
        or research_report.get("adjudication_status_counts") != {"candidate_rejected_first_entry": 51, "not_adjudicated": 93, "unresolved": 73}
