...
def validate_project_config(
    ...
    if (
        {record.get("county_fips") for record in first_entry_adjudications} != {"01069", "04013", "05119", "05145", "06037", "06055", "06079", "06085", "06095", "06099", "08001", "11001", "12001", "12057", "13067", "13117", "13121", "17019", "17031", "17043", "18089", "18105", "21071", "23005", "24005", "24031", "24033", "25017", "26125", "27019", "27109", "27123", "27137", "29019", "30017", "31153", "32003", "33015", "34003", "34017", "34023", "35001", "36087", "37119", "42091", "48085", "51107", "53033", "53061"}
        or {
...
def validate_public_data(
    ...
    if (
        treatment_registry.get("record_count") != 3242
        or len(treatment_events) != 49
        or len(treatment_evaluations) != 49
    ...
    if (
        ...
        or assessment_status_counts != Counter({"candidate_events_not_first_entry": 49, "no_reviewed_dated_operational_event": 3095})
    ...
    for county_fips, expected in expected_treatment_evaluations.items():
        ...
        if (
            ...
            or actual.get("first_entry_verification_status") != (
                "not_verified" if county_fips in {"01069", "05145", "06055", "06095", "08001", "18089", "21071", "30017", "33015", "34017"} else "rejected_as_first_entry"
            )
    ...
    if (
        ...
        or treatment_public_index.get("adjudication_count") != 49
    ...
    if (
        ...
        or treatment_report.get("reviewed_dated_operational_event_count") != 49
        or treatment_report.get("evidence_threshold_pass_count") != 35
        or treatment_report.get("period_requirement_pass_count") != 33
        or treatment_report.get("first_entry_verified_event_count") != 0
        or treatment_report.get("candidate_rejected_as_first_entry_count") != 39
        or treatment_report.get("eligible_treatment_event_count") != 0
        or treatment_report.get("eligible_county_count") != 0
        or treatment_report.get("assessment_status_counts") != {"candidate_events_not_first_entry": 49, "no_reviewed_dated_operational_event": 3095}
    ...
    if treatment_manifest.get("record_count") != 6633 or treatment_manifest_total != 6633:
    ...
    if (
        ...
        or research_tier_counts != Counter({"first_entry_deferred": 124, "first_entry_standard": 44, "first_entry_high": 49})
        ...
        or sum(record.get("dated_operational_candidate_count", 0) for record in research_candidates) != 49
    ):
    ...
    for index, record in enumerate(research_candidates):
        ...
        if (
            ...
            or record.get("research_status") != ("evidence_collected" if county_fips in {"01069", "04013", "05119", "05145", "06013", "06037", "06055", "06065", "06079", "06085", "06095", "06099", "08001", "11001", "12001", "12057", "13067", "13117", "13121", "16007", "16065", "17019", "17031", "17043", "17097", "18089", "18105", "19103", "19163", "20051", "21071", "22033", "23005", "24005", "24031", "24033", "25017", "26099", "26125", "27003", "27019", "27109", "27123", "27137", "28033", "29019", "29025", "30017", "31153", "32003", "33015", "34003", "34017", "34021", "34023", "34025", "35001", "36087", "37119", "42091", "48085", "51107", "53033", "53061"} else "queued")
    ...
    if (
        ...
        or research_report.get("priority_tier_counts") != {"first_entry_deferred": 124, "first_entry_high": 49, "first_entry_standard": 44}
        or research_report.get("initial_tranche_region_counts") != {"Midwest": 6, "Northeast": 6, "South": 6, "West": 6}
        or research_report.get("adjudication_status_counts") != {"candidate_rejected_first_entry": 39, "not_adjudicated": 168, "unresolved": 10}
