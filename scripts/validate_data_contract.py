...
def validate_project_config(
    ...
    if (
        {record.get("county_fips") for record in first_entry_adjudications} != {"04013", "06037", "06085", "12001", "12057", "13067", "13121", "17031", "17043", "18089", "18105", "23005", "25017", "26125", "31153", "32003", "33015", "34017", "35001", "36087", "37119", "42091", "51107", "53061"}
        or {
...
def validate_public_data(
    ...
    if (
        treatment_registry.get("record_count") != 3192
        or len(treatment_events) != 24
        or len(treatment_evaluations) != 24
    ...
    if (
        ...
        or assessment_status_counts != Counter({"candidate_events_not_first_entry": 24, "no_reviewed_dated_operational_event": 3120})
    ...
    if (
        {record.get("county_fips") for record in adjudicated_assessments} != {"04013", "06037", "06085", "12001", "12057", "13067", "13121", "17031", "17043", "18089", "18105", "23005", "25017", "26125", "31153", "32003", "33015", "34017", "35001", "36087", "37119", "42091", "51107", "53061"}
        or {
            record.get("county_fips"): record.get("candidate_rejection_count")
            for record in adjudicated_assessments
        } != {"04013": 1, "06037": 1, "06085": 1, "12001": 1, "12057": 1, "13067": 1, "13121": 1, "17031": 1, "17043": 1, "18089": 0, "18105": 1, "23005": 1, "25017": 1, "26125": 1, "31153": 1, "32003": 1, "33015": 0, "34017": 0, "35001": 1, "36087": 1, "37119": 1, "42091": 1, "51107": 1, "53061": 1}
    ...
    for county_fips, expected in expected_treatment_evaluations.items():
        ...
        if (
            ...
            or actual.get("first_entry_verification_status") != (
                "not_verified" if county_fips in {"18089", "33015", "34017"} else "rejected_as_first_entry"
            )
    ...
    if (
        ...
        or treatment_public_index.get("adjudication_count") != 24
    ...
    if (
        ...
        or treatment_report.get("reviewed_dated_operational_event_count") != 24
        or treatment_report.get("evidence_threshold_pass_count") != 18
        or treatment_report.get("period_requirement_pass_count") != 17
        or treatment_report.get("first_entry_verified_event_count") != 0
        or treatment_report.get("candidate_rejected_as_first_entry_count") != 21
        or treatment_report.get("eligible_treatment_event_count") != 0
        or treatment_report.get("eligible_county_count") != 0
        or treatment_report.get("assessment_status_counts") != {"candidate_events_not_first_entry": 24, "no_reviewed_dated_operational_event": 3120}
    ...
    if treatment_manifest.get("record_count") != 6476 or treatment_manifest_total != 6476:
    ...
    if (
        ...
        or research_tier_counts != Counter({"first_entry_deferred": 124, "first_entry_standard": 69, "first_entry_high": 24})
        ...
        or sum(record.get("dated_operational_candidate_count", 0) for record in research_candidates) != 24
    ):
    ...
    for index, record in enumerate(research_candidates):
        ...
        if (
            ...
            or record.get("research_status") != ("evidence_collected" if county_fips in {"04013", "06037", "06085", "12001", "12057", "13067", "13121", "17031", "17043", "18089", "18105", "23005", "25017", "26125", "31153", "32003", "33015", "34017", "35001", "36087", "37119", "42091", "51107", "53061"} else "queued")
    ...
    if (
        ...
        or research_report.get("priority_tier_counts") != {"first_entry_deferred": 124, "first_entry_high": 24, "first_entry_standard": 69}
        or research_report.get("initial_tranche_region_counts") != {"Midwest": 6, "Northeast": 6, "South": 6, "West": 6}
        or research_report.get("adjudication_status_counts") != {"candidate_rejected_first_entry": 21, "not_adjudicated": 193, "unresolved": 3}
    ...
    if national_tranche_2_sources_document.get("record_count") != 13 or len(national_tranche_2_sources) != 13:
        issues.append(Issue("public_data_validation", national_tranche_2_sources_path.name, "expected thirteen governed evidence sources"))
    ...
    if national_tranche_4_sources_document.get("record_count") != 17 or len(national_tranche_4_sources) != 17:
        issues.append(Issue("public_data_validation", national_tranche_4_sources_path.name, "expected seventeen governed evidence sources"))
    ...
    if national_tranche_5_sources_document.get("record_count") != 16 or len(national_tranche_5_sources) != 16:
        issues.append(Issue("public_data_validation", national_tranche_5_sources_path.name, "expected sixteen governed evidence sources"))
