...
def validate_public_data(
    ...
    if (
        treatment_registry.get("record_count") != 3408
        or len(treatment_events) != 132
        or len(treatment_evaluations) != 132
    ...
    if (
        ...
        or assessment_status_counts != Counter({"candidate_events_not_first_entry": 132, "no_reviewed_dated_operational_event": 3012})
    ...
    if (
        ...
        or treatment_public_index.get("adjudication_count") != 132
    ...
    if (
        ...
        or treatment_report.get("reviewed_dated_operational_event_count") != 132
        or treatment_report.get("evidence_threshold_pass_count") != 83
        or treatment_report.get("period_requirement_pass_count") != 72
        ...
        or treatment_report.get("assessment_status_counts") != {"candidate_events_not_first_entry": 132, "no_reviewed_dated_operational_event": 3012}
    ...
    if treatment_manifest.get("record_count") != 7083 or treatment_manifest_total != 7083:
    ...
    if (
        ...
        or research_tier_counts != Counter({"first_entry_deferred": 61, "first_entry_standard": 24, "first_entry_high": 132})
        ...
        or sum(record.get("dated_operational_candidate_count", 0) for record in research_candidates) != 132
    ):
    ...
    if (
        ...
        or research_report.get("priority_tier_counts") != {"first_entry_deferred": 61, "first_entry_high": 132, "first_entry_standard": 24}
        or research_report.get("initial_tranche_region_counts") != {"Midwest": 6, "Northeast": 6, "South": 6, "West": 6}
        or research_report.get("adjudication_status_counts") != {"candidate_rejected_first_entry": 52, "not_adjudicated": 85, "unresolved": 80}
