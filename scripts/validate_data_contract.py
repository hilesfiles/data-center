...
def validate_project_config(
    ...
    if (
        {record.get("county_fips") for record in first_entry_adjudications} != {"04013", "06085", "13121"}
...
def validate_public_data(
    ...
    if (
        treatment_registry.get("record_count") != 3150
        or len(treatment_events) != 3
        or len(treatment_evaluations) != 3
    ...
    if (
        ...
        or assessment_status_counts != Counter({"candidate_events_not_first_entry": 3, "no_reviewed_dated_operational_event": 3141})
    ...
    if (
        {record.get("county_fips") for record in adjudicated_assessments} != {"04013", "06085", "13121"}
    ...
    if (
        ...
        or treatment_public_index.get("adjudication_count") != 3
    ...
    if (
        ...
        or treatment_report.get("reviewed_dated_operational_event_count") != 3
        ...
        or treatment_report.get("assessment_status_counts") != {"candidate_events_not_first_entry": 3, "no_reviewed_dated_operational_event": 3141}
    ...
    if treatment_manifest.get("record_count") != 6313 or treatment_manifest_total != 6313:
    ...
    if (
        ...
        or research_tier_counts != Counter({"first_entry_deferred": 124, "first_entry_standard": 90, "first_entry_high": 3})
        ...
        or sum(record.get("dated_operational_candidate_count", 0) for record in research_candidates) != 3
    ):
    ...
    expected_research_initial_fips = [
        "13121", "04013", "06085", "34017", "32003", "18105", "26125", "17031",
    ...
    for index, record in enumerate(research_candidates):
        ...
        if (
            ...
            or record.get("research_status") != ("evidence_collected" if county_fips in {"04013", "06085", "13121"} else "queued")
    ...
    if (
        ...
        or research_report.get("priority_tier_counts") != {"first_entry_deferred": 124, "first_entry_high": 3, "first_entry_standard": 90}
        or research_report.get("initial_tranche_region_counts") != {"Midwest": 6, "Northeast": 6, "South": 6, "West": 6}
        or research_report.get("adjudication_status_counts") != {"candidate_rejected_first_entry": 3, "not_adjudicated": 214}
    ...
    if national_tranche_sources_document.get("record_count") != 8 or len(national_tranche_sources) != 8:
        issues.append(Issue("public_data_validation", national_tranche_sources_path.name, "expected eight governed evidence sources"))
