...
def validate_project_config(
    ...
    if (
        {record.get("county_fips") for record in first_entry_adjudications} != {"04013", "06085", "13121", "34017"}
        or {
...
def validate_public_data(
    ...
    if (
        treatment_registry.get("record_count") != 3152
        or len(treatment_events) != 4
        or len(treatment_evaluations) != 4
    ...
    if (
        ...
        or assessment_status_counts != Counter({"candidate_events_not_first_entry": 4, "no_reviewed_dated_operational_event": 3140})
    ...
    if (
        {record.get("county_fips") for record in adjudicated_assessments} != {"04013", "06085", "13121", "34017"}
        or {
            record.get("county_fips"): record.get("candidate_rejection_count")
            for record in adjudicated_assessments
        } != {"04013": 1, "06085": 1, "13121": 1, "34017": 0}
    ...
    if (
        ...
        or treatment_public_index.get("adjudication_count") != 4
    ...
    if (
        ...
        or treatment_report.get("reviewed_dated_operational_event_count") != 4
        ...
        or treatment_report.get("candidate_rejected_as_first_entry_count") != 3
        or treatment_report.get("eligible_treatment_event_count") != 0
        or treatment_report.get("eligible_county_count") != 0
        or treatment_report.get("assessment_status_counts") != {"candidate_events_not_first_entry": 4, "no_reviewed_dated_operational_event": 3140}
    ...
    if treatment_manifest.get("record_count") != 6319 or treatment_manifest_total != 6319:
    ...
    if (
        ...
        or research_tier_counts != Counter({"first_entry_deferred": 124, "first_entry_standard": 89, "first_entry_high": 4})
        ...
        or sum(record.get("dated_operational_candidate_count", 0) for record in research_candidates) != 4
    ):
    ...
    expected_research_initial_fips = [
        "13121", "34017", "04013", "06085", "32003", "18105", "26125", "17031",
    ...
    for index, record in enumerate(research_candidates):
        ...
        if (
            ...
            or record.get("research_status") != ("evidence_collected" if county_fips in {"04013", "06085", "13121", "34017"} else "queued")
    ...
    if (
        ...
        or research_report.get("priority_tier_counts") != {"first_entry_deferred": 124, "first_entry_high": 4, "first_entry_standard": 89}
        or research_report.get("initial_tranche_region_counts") != {"Midwest": 6, "Northeast": 6, "South": 6, "West": 6}
        or research_report.get("adjudication_status_counts") != {"candidate_rejected_first_entry": 3, "not_adjudicated": 213, "unresolved": 1}
    ...
    if national_tranche_6_sources_document.get("record_count") != 18 or len(national_tranche_6_sources) != 18:
        issues.append(Issue("public_data_validation", national_tranche_6_sources_path.name, "expected eighteen governed evidence sources"))
