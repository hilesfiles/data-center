...
def validate_project_config(
    ...
    if (
        {record.get("county_fips") for record in first_entry_adjudications} != {"01069", "04013", "05119", "05145", "06037", "06055", "06079", "06085", "06095", "06099", "08001", "11001", "12001", "12057", "13067", "13117", "13121", "17019", "17031", "17043", "18089", "18105", "21071", "23005", "25017", "26125", "31153", "32003", "33015", "34017", "34023", "35001", "36087", "37119", "42091", "48085", "51107", "53033", "53061"}
        or {
...
def validate_public_data(
    ...
    if (
        treatment_registry.get("record_count") != 3222
        or len(treatment_events) != 39
        or len(treatment_evaluations) != 39
    ...
    if (
        ...
        or assessment_status_counts != Counter({"candidate_events_not_first_entry": 39, "no_reviewed_dated_operational_event": 3105})
    ...
    if (
        {record.get("county_fips") for record in adjudicated_assessments} != {"01069", "04013", "05119", "05145", "06037", "06055", "06079", "06085", "06095", "06099", "08001", "11001", "12001", "12057", "13067", "13117", "13121", "17019", "17031", "17043", "18089", "18105", "21071", "23005", "25017", "26125", "31153", "32003", "33015", "34017", "34023", "35001", "36087", "37119", "42091", "48085", "51107", "53033", "53061"}
        or {
            record.get("county_fips"): record.get("candidate_rejection_count")
            for record in adjudicated_assessments
        } != {"01069": 0, "04013": 1, "05119": 1, "05145": 0, "06037": 1, "06055": 0, "06079": 1, "06085": 1, "06095": 0, "06099": 1, "08001": 0, "11001": 1, "12001": 1, "12057": 1, "13067": 1, "13117": 1, "13121": 1, "17019": 1, "17031": 1, "17043": 1, "18089": 0, "18105": 1, "21071": 0, "23005": 1, "25017": 1, "26125": 1, "31153": 1, "32003": 1, "33015": 0, "34017": 0, "34023": 1, "35001": 1, "36087": 1, "37119": 1, "42091": 1, "48085": 1, "51107": 1, "53033": 1, "53061": 1}
    ...
    if (
        ...
        or treatment_public_index.get("adjudication_count") != 39
    ...
    if (
        ...
        or treatment_report.get("reviewed_dated_operational_event_count") != 39
        or treatment_report.get("evidence_threshold_pass_count") != 28
        or treatment_report.get("period_requirement_pass_count") != 25
        or treatment_report.get("first_entry_verified_event_count") != 0
        or treatment_report.get("candidate_rejected_as_first_entry_count") != 30
        or treatment_report.get("eligible_treatment_event_count") != 0
        or treatment_report.get("eligible_county_count") != 0
        or treatment_report.get("assessment_status_counts") != {"candidate_events_not_first_entry": 39, "no_reviewed_dated_operational_event": 3105}
    ...
    if treatment_manifest.get("record_count") != 6566 or treatment_manifest_total != 6566:
    ...
    if (
        ...
        or research_tier_counts != Counter({"first_entry_deferred": 124, "first_entry_standard": 54, "first_entry_high": 39})
        ...
        or sum(record.get("dated_operational_candidate_count", 0) for record in research_candidates) != 39
    ):
    ...
    for index, record in enumerate(research_candidates):
        ...
        if (
            ...
            or record.get("research_status") != ("evidence_collected" if county_fips in {"01069", "04013", "05119", "05145", "06013", "06037", "06055", "06065", "06079", "06085", "06095", "06099", "08001", "11001", "12001", "12057", "13067", "13117", "13121", "16007", "16065", "17019", "17031", "17043", "17097", "18089", "18105", "19103", "19163", "20051", "21071", "22033", "23005", "25017", "26125", "31153", "32003", "33015", "34017", "34023", "35001", "36087", "37119", "42091", "48085", "51107", "53033", "53061"} else "queued")
    ...
    if (
        ...
        or research_report.get("priority_tier_counts") != {"first_entry_deferred": 124, "first_entry_high": 39, "first_entry_standard": 54}
        or research_report.get("initial_tranche_region_counts") != {"Midwest": 6, "Northeast": 6, "South": 6, "West": 6}
        or research_report.get("adjudication_status_counts") != {"candidate_rejected_first_entry": 30, "not_adjudicated": 178, "unresolved": 9}
