...
def validate_public_data(
    ...
    if national_tranche_6_sources_document.get("record_count") != 17 or len(national_tranche_6_sources) != 17:
        issues.append(Issue("public_data_validation", national_tranche_6_sources_path.name, "expected seventeen governed evidence sources"))
