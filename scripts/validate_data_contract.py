...
def validate_project_config(
    ...
    new_first_entry_expected = {"39041", "40101", "41017"}
...
def validate_public_data(
    ...
    if (
        treatment_registry.get("record_count") != 3432
        or len(treatment_events) != 144
        or len(treatment_evaluations) != 144
    ...
    if (
        ...
        or assessment_status_counts != Counter({"candidate_events_not_first_entry": 144, "no_reviewed_dated_operational_event": 3000})
    ...
    new_adjudicated_assessments = [
        ...
        if record.get("county_fips") in {"39041", "40101", "41017"}
    ]
    if (
        {record.get("county_fips") for record in new_adjudicated_assessments} != {"39041", "40101", "41017"}
    ...
    adjudicated_assessments = [
        record for record in adjudicated_assessments
        if record.get("county_fips") not in {"39041", "40101", "41017"}
    ]
    if (
    ...
    for county_fips, expected in expected_treatment_evaluations.items():
        ...
        if (
            ...
            or actual.get("first_entry_verification_status") != (
                "not_verified" if county_fips in {"39041", "40101", "41017"} else
    ...
    if (
        ...
        or treatment_public_index.get("adjudication_count") != 144
    ...
    if (
        ...
        or treatment_report.get("reviewed_dated_operational_event_count") != 144
        or treatment_report.get("evidence_threshold_pass_count") != 88
        or treatment_report.get("period_requirement_pass_count") != 78
        ...
        or treatment_report.get("assessment_status_counts") != {"candidate_events_not_first_entry": 144, "no_reviewed_dated_operational_event": 3000}
    ...
    if treatment_manifest.get("record_count") != 7151 or treatment_manifest_total != 7151:
    ...
    if (
        ...
        or research_tier_counts != Counter({"first_entry_deferred": 49, "first_entry_standard": 24, "first_entry_high": 144})
        ...
        or sum(record.get("dated_operational_candidate_count", 0) for record in research_candidates) != 144
    ):
    ...
    for index, record in enumerate(research_candidates):
        ...
        if county_fips in {"34015", "35013", "36119", "39041", "39043", "40101", "41017", "47057"}:
    ...
    if (
        ...
        or research_report.get("priority_tier_counts") != {"first_entry_deferred": 49, "first_entry_high": 144, "first_entry_standard": 24}
        or research_report.get("initial_tranche_region_counts") != {"Midwest": 6, "Northeast": 6, "South": 6, "West": 6}
        or research_report.get("adjudication_status_counts") != {"candidate_rejected_first_entry": 52, "not_adjudicated": 73, "unresolved": 92}
