...
def validate_project_config(
    ...
    if (
        {record.get("county_fips") for record in first_entry_adjudications} != {"01069", "04013", "05119", "05145", "06037", "06055", "06079", "06085", "06095", "06099", "08001", "11001", "12001", "12057", "13067", "13117", "13121", "17019", "17031", "17043", "18089", "18105", "21071", "23005", "24005", "24031", "24033", "25017", "26125", "27019", "27109", "27123", "31153", "32003", "33015", "34017", "34023", "35001", "36087", "37119", "42091", "48085", "51107", "53033", "53061"}
        or {
...
def validate_public_data(
    ...
    if (
        treatment_registry.get("record_count") != 3234
        or len(treatment_events) != 45
        or len(treatment_evaluations) != 45
    ...
    if (
        ...
        or assessment_status_counts != Counter({"candidate_events_not_first_entry": 45, "no_reviewed_dated_operational_event": 3099})
    ...
    for county_fips, expected in expected_treatment_evaluations.items():
        ...
        if (
            ...
            or actual.get("first_entry_verification_status") != (
                "not_verified" if county_fips in {"01069", "05145", "06055", "06095", "08001", "18089", "21071", "33015", "34017"} else "rejected_as_first_entry"
            )
    ...
    if (
        ...
        or treatment_public_index.get("adjudication_count") != 45
    ...
    if (
        ...
        or treatment_report.get("reviewed_dated_operational_event_count") != 45
        or treatment_report.get("evidence_threshold_pass_count") != 33
        or treatment_report.get("period_requirement_pass_count") != 30
        or treatment_report.get("first_entry_verified_event_count") != 0
        or treatment_report.get("candidate_rejected_as_first_entry_count") != 36
        or treatment_report.get("eligible_treatment_event_count") != 0
        or treatment_report.get("eligible_county_count") != 0
        or treatment_report.get("assessment_status_counts") != {"candidate_events_not_first_entry": 45, "no_reviewed_dated_operational_event": 3099}
    ...
    if treatment_manifest.get("record_count") != 6607 or treatment_manifest_total != 6607:
    ...
    if (
        ...
        or research_tier_counts != Counter({"first_entry_deferred": 124, "first_entry_standard": 48, "first_entry_high": 45})
        ...
        or sum(record.get("dated_operational_candidate_count", 0) for record in research_candidates) != 45
    ):
    ...
    for index, record in enumerate(research_candidates):
        ...
        if (
            ...
            or record.get("research_status") != ("evidence_collected" if county_fips in {"01069", "04013", "05119", "05145", "06013", "06037", "06055", "06065", "06079", "06085", "06095", "06099", "08001", "11001", "12001", "12057", "13067", "13117", "13121", "16007", "16065", "17019", "17031", "17043", "17097", "18089", "18105", "19103", "19163", "20051", "21071", "22033", "23005", "24005", "24031", "24033", "25017", "26099", "26125", "27003", "27019", "27109", "27123", "31153", "32003", "33015", "34017", "34023", "35001", "36087", "37119", "42091", "48085", "51107", "53033", "53061"} else "queued")
    ...
    if (
        ...
        or research_report.get("priority_tier_counts") != {"first_entry_deferred": 124, "first_entry_high": 45, "first_entry_standard": 48}
        or research_report.get("initial_tranche_region_counts") != {"Midwest": 6, "Northeast": 6, "South": 6, "West": 6}
        or research_report.get("adjudication_status_counts") != {"candidate_rejected_first_entry": 36, "not_adjudicated": 172, "unresolved": 9}
