...
def validate_public_data(
    ...
    if (
        treatment_registry.get("record_count") != 3332
        or len(treatment_events) != 94
        or len(treatment_evaluations) != 94
    ...
    if (
        ...
        or assessment_status_counts != Counter({"candidate_events_not_first_entry": 94, "no_reviewed_dated_operational_event": 3050})
    ...
    if (
        ...
        or treatment_public_index.get("adjudication_count") != 94
    ...
    if (
        ...
        or treatment_report.get("reviewed_dated_operational_event_count") != 94
        or treatment_report.get("evidence_threshold_pass_count") != 57
        or treatment_report.get("period_requirement_pass_count") != 56
        ...
        or treatment_report.get("assessment_status_counts") != {"candidate_events_not_first_entry": 94, "no_reviewed_dated_operational_event": 3050}
    ...
    if treatment_manifest.get("record_count") != 6894 or treatment_manifest_total != 6894:
    ...
    if (
        ...
        or research_tier_counts != Counter({"first_entry_deferred": 99, "first_entry_standard": 24, "first_entry_high": 94})
        ...
        or sum(record.get("dated_operational_candidate_count", 0) for record in research_candidates) != 94
    ):
    ...
    if (
        ...
        or research_report.get("priority_tier_counts") != {"first_entry_deferred": 99, "first_entry_high": 94, "first_entry_standard": 24}
        or research_report.get("initial_tranche_region_counts") != {"Midwest": 6, "Northeast": 6, "South": 6, "West": 6}
        or research_report.get("adjudication_status_counts") != {"candidate_rejected_first_entry": 51, "not_adjudicated": 123, "unresolved": 43}
