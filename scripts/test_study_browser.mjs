...
try {
  ...
  assert.match(await page.locator(".comparison-summary").innerText(), /35[\s\S]*420[\s\S]*241[\s\S]*2,382/);
  assert.match(await page.locator(".comparison-caveat").innerText(), /131 counties surfaced by candidate-specific research were removed/i);
