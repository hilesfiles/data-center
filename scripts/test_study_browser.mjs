...
try {
  ...
  assert.match(await page.locator(".comparison-summary").innerText(), /35[\s\S]*420[\s\S]*233[\s\S]*2,326/);
  assert.match(await page.locator(".comparison-caveat").innerText(), /187 counties surfaced by candidate-specific research were removed/i);
