...
try {
  ...
  assert.match(await page.locator(".comparison-summary").innerText(), /35[\s\S]*420[\s\S]*229[\s\S]*2,314/);
  assert.match(await page.locator(".comparison-caveat").innerText(), /199 counties surfaced by candidate-specific research were removed/i);
