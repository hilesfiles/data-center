...
try {
  ...
  assert.match(await page.locator(".comparison-summary").innerText(), /35[\s\S]*420[\s\S]*230[\s\S]*2,296/);
  assert.match(await page.locator(".comparison-caveat").innerText(), /217 counties surfaced by candidate-specific research were removed/i);
