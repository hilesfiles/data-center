...
The current evidence contains 72 reviewed dated facility events. Forty-three pass the evidence
gate and 43 pass the panel-window gate, but zero have verified county-first-entry status, so model readiness is
