...
Treatment timing is a separate gate. Ten of the 35 active-project host counties now have governed anchor decisions, and none is causal-ready. Tarrant County is left-censored by a data center built in 2000; Bexar County has material exposure before the selected building's 2013 history anchor; Douglas County lacks the required preperiod; and the Montgomery County, Tennessee, Montgomery County, Texas, and Utah County operational dates remain provisional until countywide first-E3 histories are complete.
