...
- County first-entry treatment: all 3,144 counties have governed assessments. Dated candidates
  in Santa Clara, Maricopa, Fulton, Clark, and Monroe counties are each rejected by documented
  earlier
  ...
  predecessor operation, and Fulton and Hudson also do not pass both gates.
...
Continue the remaining 18 counties in the initial tranche against local-government, permit,
