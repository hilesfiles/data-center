...
The current evidence contains 100 reviewed dated facility events. Sixty pass the evidence
gate and 59 pass the panel-window gate, but zero have verified county-first-entry status, so model readiness is
