...
Treatment timing is a separate gate. Ten of the 35 active-project host counties now have governed anchor decisions, and none is causal-ready. Three counties have completed the required seven-domain treatment-history review. Montgomery County, Tennessee, retains a provisional Google anchor because the review found no earlier E3-scale facility but could not close every historical institutional and enterprise inventory. Montgomery County, Texas, and Utah County reject the selected Stream and Meta projects as first-entry treatments because governed evidence establishes earlier material exposure; the counties' true first-E3 dates remain unresolved. Tarrant County is left-censored by a data center built in 2000, Bexar County has material exposure before the selected building's 2013 history anchor, and Douglas County lacks the required preperiod.
