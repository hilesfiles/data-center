...
Treatment timing is a separate gate. Seventeen of the 35 active-project host counties now have governed anchor decisions, and none is causal-ready. Eleven counties have completed the required seven-domain treatment-history review. Jackson County, Alabama, Lake County, Indiana, Polk and Pottawattamie Counties, Iowa, Johnson County, Kansas, Catawba County, North Carolina, Valencia County, New Mexico, Montgomery County, Tennessee, and Storey County, Nevada, retain provisional anchors because their reviews could not close every historical institutional and enterprise inventory. Lake County's review explicitly records earlier institutional HPC and smaller commercial data-center activity, neither yet shown to cross E3 materiality; Digital Crossroad is therefore only a provisional first-E3 candidate. Polk County's corrected review identifies LightEdge's November 2006 Altoona facility as earlier E2 colocation exposure, removes the false attribution of Microsoft's Dallas County Project Mountain to Polk County, and moves Meta's governed E3 construction upper bound from its November 2014 opening to August 2013. Pottawattamie's review identifies infoUSA's pre-Google Carter Lake enterprise data center as earlier E1 exposure, separates Google's June 2007 public commitment and 2007 construction from its May 2009 opening ceremony, and retains 2007 only as a provisional first-E3 year. Johnson County's review rejects State Farm as first entry, documents QTS commercial operation by 2003 and Cavern commercial colocation from 2007, and uses Cavern's late-2014 expansion above 100,000 completed square feet as the provisional first-E3 upper bound. Catawba's review separates Apple's July 6, 2009 county-specific announcement, August 14 grading, and June 2010 opening; the grading date is the provisional first-E3 physical-exposure anchor, while the incomplete pre-Apple institutional and enterprise inventory prevents causal-ready use. Storey's governed construction upper bound moves from the project's 2017 page anchor to September 2015, while Valencia's moves from the project's February 2019 grand opening to the October 2016 construction milestone. Concurrent Tesla Gigafactory construction creates a severe separate contamination risk for Storey County. Montgomery County, Texas, and Utah County reject the selected Stream and Meta projects as first-entry treatments because governed evidence establishes earlier material exposure; the counties' true first-E3 dates remain unresolved. Tarrant County is left-censored by a data center built in 2000, Bexar County has material exposure before the selected building's 2013 history anchor, and Douglas County lacks the required preperiod.
...
The controlling primary workstream is now the [national county-expansion and impact-analysis roadmap](docs/primary-workstream-roadmap.md). The immediate analytical priority is to normalize and deduplicate the complete IM3, lifecycle, SueDataCenters, and DEPLOY source universe; classify lifecycle and economic materiality; resolve geographic gaps; and publish a national county-exposure register. The original 35 counties remain the curated case-study cohort, not the final treated-county population. Serial county treatment-history or control-absence reviews resume only after the national universe is ranked and only within a published analytical tranche.

## Methodology and design documents

- [`docs/primary-workstream-roadmap.md`](docs/primary-workstream-roadmap.md) — controlling execution order, phase gates, deliverables, and status-reporting contract
