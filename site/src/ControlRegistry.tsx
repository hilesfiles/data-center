...
export function ControlRegistry() {
  ...
  return <article className="control-registry">
    <header className="control-hero"><span className="eyebrow">Counties with and without data centers</span><h2>Comparable communities.<br />Different exposure.</h2><p>Each of the 35 active-project host counties now has a 12-county analytical reserve drawn from counties with zero linked data-center facility or project records across three national screens and no governed local positive-exposure finding. The five strongest preliminary matches are shown while every candidate remains subject to local facility-absence verification.</p></header>
