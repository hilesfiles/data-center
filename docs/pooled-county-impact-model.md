...
Study release `private-sector-study-1.45.0` contains 36 selected projects across 35 counties and 23 states. Six projects currently pass the completed-contribution-account gate: Apple Mesa / Maricopa County, Switch Citadel / Storey County, Digital Crossroad Hammond / Lake County, Meta Forest City / Rutherford County, Microsoft San Antonio / Bexar County, and EdgeConneX DET01 / Oakland County. The other 30 projects remain incomplete, including the three deeply researched Batch 2 accounts whose unbounded supplier or community gaps are not filled merely to pass the gate. The current release contains 647 source records and 176 separately governed modeled syntheses, but no pooled estimate and no causal estimate.
