...
Study release `private-sector-study-1.50.0` contains 36 selected projects across 35 counties and 23 states. Eighteen projects have completed scoped research audits and remain visible on the community map. Three projects currently pass the separate completed-contribution-account analytical gate: Apple Mesa / Maricopa County, Switch Citadel / Storey County, and Digital Crossroad Hammond / Lake County. The other 33 projects remain analytically incomplete; unbounded supplier, community, construction, operating, resource, or public-cost gaps are not filled merely to pass the gate. The current release contains 769 source records and 149 separately governed modeled syntheses, but no pooled estimate and no causal estimate.
