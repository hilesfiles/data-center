...
5 September 2026. Revised research and implementation sequence. The application remediation is implemented locally through `private-sector-study-1.37.0`: the study register, project evidence profiles, and map/county navigation are available. Thirty-six evidence batches contain 560 economic source records across all 36 candidates, with 512 reported observations and 48 projections separated. The three depth accounts cover Meta Forest City, Digital Crossroad Hammond and Switch Citadel. The Switch account now separates real property, personal property, tax bills, verified payments, direct Fire District contributions, a paired public-equipment cost, agreement projections and audit findings. Complete annual economic accounts and project-event impact analysis remain subsequent work. Existing inventory adjudications and treatment definitions retain their original meaning; no impact findings or public deployment changes are implied.
...
The 36-project register is accessible through the application, and all candidates now have at least one quantitative record. The thirty-six evidence batches contain 560 source-checked records: 512 reported observations and 48 forecasts. Meta Forest City combines assessed values and paired county receipts/incentives with separately scoped investment, employment, community funding and infrastructure evidence. Digital Crossroad Hammond combines property, investment, employment, financing, supplier, incentive, tax, resource and county-industry evidence while retaining quarterly local-labor records as an acquisition target. Switch Citadel combines separate real- and personal-property histories, parcel and account bills and payments, Fire District contribution reports, a public-equipment cost forecast, state-reported agreement-level audit outcomes and original incentive projections; the identical Clark County audit row remains an explicit allocation caution. Campus/company scope, accounting stocks, snapshots, construction peaks, cumulative costs, paired taxes/incentives, taxpayer accounts, fiscal/calendar/tax-year values, permit capacities and source projections remain separate. Continue with annual actual investment, employment/payroll, local-purchase detail, recipient-level receipts, realized public-service costs and measured resources, then assess readiness separately for each economic analysis. No profile yet establishes a complete annual fiscal balance or net community benefit.
