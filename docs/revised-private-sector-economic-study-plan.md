...
8 September 2026. Revised research and implementation sequence. Release `private-sector-study-1.59.0` combines 1,700 economic source records across all 36 candidates—1,539 reported observations and 161 projections—with 278 separately governed syntheses. The selected register spans 35 counties and 23 states. All 36 projects have completed scoped research audits and are mapped; Google Berkeley County passes the mechanical full contribution-account coverage gate while the other accounts retain explicit gaps. The versioned modeling policy requires auditable public-source exhaustion before last-resort synthesis, separate forecasts, reproducible parameters, explicit interval kinds, defensible scope, contribution-channel separation, anti-overlap aggregation and method-specific causal or multiplier metadata. The current release publishes no pooled or causal estimate and makes no net-fiscal claim without same-scope public-cost evidence.
