...
6 September 2026. Revised research and implementation sequence. Release `private-sector-study-1.51.0` combines 931 economic source records across all 36 candidates—826 reported observations and 105 projections—with 155 separately governed syntheses. The selected register spans 35 counties and 23 states. Twenty-one projects have completed scoped research audits and are mapped; three currently pass the separate completed-contribution-account analytical gate, and 33 remain analytically incomplete. The versioned modeling policy requires auditable public-source exhaustion before last-resort synthesis, separate forecasts, reproducible parameters, explicit interval kinds, defensible scope, contribution-channel separation, anti-overlap aggregation and method-specific causal or multiplier metadata. The current release publishes no pooled or causal estimate and makes no net-fiscal claim without same-scope public-cost evidence.
