...
5 September 2026. Revised research and implementation sequence. Release `private-sector-study-1.40.0` combines 585 economic source records across all 36 candidates—533 reported observations and 52 projections—with 33 separately governed syntheses: 13 for Apple Mesa and 20 for Switch Citadel / Tahoe Reno 1. The Storey pass adds public-evidence capital floors, bounded direct construction and operating scenarios, account-preserving fiscal reconciliation, resource engineering and a deliberately noncausal county outcome summary. The versioned modeling policy requires direct-evidence search first, separate forecasts, reproducible parameters, explicit interval kinds, defensible scope, contribution-channel separation, anti-overlap aggregation and method-specific causal or multiplier metadata. Unsupported local-supplier, indirect, induced, strategic-infrastructure and causal values remain documented gaps.
...
The 36-project register is accessible through the application, and all candidates now have at least one quantitative source record. The economic-evidence register contains 585 source-checked records: 533 reported records and 52 forecasts. Thirty-three modeled syntheses are counted separately—13 Apple Mesa and 20 Switch Citadel. The Meta Forest City depth case combines five years of assessed values and paired county receipts/incentives with separately scoped investment, employment, community-funding and infrastructure evidence. Digital Crossroad Hammond combines five leasehold real-property values and account-tax evidence with a separate personal-property assessment, qualified cumulative investment, audited 2024-2025 fund cost basis and fair value, a developer-reported greater-than-$80-million local-contractor spending lower bound, a 17-employee snapshot, audited TIF bond draws, balances and debt-service flows, potential owner-assessment caps, private-fund project-tax repayment flows, audited private equipment-credit balances, reported operating floor area and commissioned-capacity occupancy, named construction and engineering roles, a state EDGE contract with dated payment status, a charging-infrastructure award, commissioned and utility-feed capacity, water-permit limits and permit-listed backup equipment. Its current public-debt screen finds the existing Series 2019 bond but no separately reported EID debt, while the unsubmitted 2025 Annual Financial Report prevents extension of the audited City debt series. Switch Citadel preserves separate real- and personal-property accounts, direct Fire District contributions, public-equipment costs, agreement projections and audit findings; its models add transparent capital floors, direct labor scenarios, account-level fiscal reconciliation and resource ranges without claiming indirect, induced, causal or strategic effects. Campus/company scope, accounting stocks, snapshots, construction peaks, cumulative costs, paired taxes/incentives, separate taxpayer bills, distinct pledged-revenue and transfer measures, fiscal/calendar/tax-year assessed values, permit capacities, ambiguous source years, source projections and modeled syntheses remain separate. Continue with annual actual investment, local-purchase detail, recipient-level receipts, attributable public costs and measured resources, then assess readiness separately for each economic analysis. No profile yet establishes a complete annual fiscal balance or net community benefit.
