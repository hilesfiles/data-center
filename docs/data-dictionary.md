...
| Analytical input | panel row, county economic history, treatment definition, analysis unit | Build reproducible samples without mixing model outputs into raw observations |
...
| Publication | public county summary, county economic baseline, county employment-and-wages baseline, county economic history, facility-source coverage, entity-resolution record/coverage, dataset manifest | Deliver small versioned JSON projections to GitHub Pages |
