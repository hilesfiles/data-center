...
| Evidence | source, source artifact, claim, claim resolution, review decision | Trace every material assertion and conflict |
...
| Publication | public county summary, public facility-source coverage, dataset manifest | Deliver small versioned JSON projections to GitHub Pages |
