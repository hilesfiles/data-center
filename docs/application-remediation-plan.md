...
5 September 2026. Companion to the [revised study plan](revised-private-sector-economic-study-plan.md). The application remediation is implemented locally through `private-sector-study-1.39.0`, including browser verification. Release 2 now contains 584 source records across three depth accounts and a separately governed modeled-synthesis layer. Complete annual accounts and Release 3 remain the implementation roadmap. The public deployment has not been changed.
...
Study release `private-sector-study-1.39.0` publishes 584 source-checked records across all 36 candidates—532 reported observations and 52 forecasts—plus 13 separately governed Apple Mesa syntheses. The three depth accounts cover Meta Forest City, Digital Crossroad Hammond and Switch Citadel. Storey retains its real- and personal-property accounts, tax bills and verified payments, Fire District contributions and paired equipment-cost forecast. Apple Mesa adds operating electricity, renewable capacity, permit valuations, cumulative investment, employment and incentive forecasts, FTZ context, and transparently modeled water, employment, payroll, electricity cost, gross location-based emissions and incentive counterfactuals. The generic synthesis contract and machine-readable policy apply across facilities and counties without publishing estimates for another real facility. Typed intervals, contribution channels, aggregation controls, named parameter provenance and causal or multiplier requirements keep models outside canonical claims and realized-benefit totals.
