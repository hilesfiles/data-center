...
Study release `private-sector-study-1.48.0` publishes 692 source-checked records across all 36 candidates—626 reported observations and 66 forecasts—plus 146 separately governed syntheses. Twelve projects have completed scoped research audits and are map-eligible; the separate full modeled-account gate remains at three. Batch 3 adds 32 source records and only eight eligible syntheses after persistent project-specific source review. Typed intervals, contribution channels, aggregation controls, named parameter provenance, and causal or multiplier requirements keep models outside canonical claims and realized-benefit totals.
