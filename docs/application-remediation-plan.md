...
Study release `private-sector-study-1.35.0` publishes 545 source-checked records across all 36 candidates: 498 reported observations and 47 forecasts. The depth accounts now include Meta Forest City, Digital Crossroad Hammond and Switch Citadel. Release 1.35 adds Nevada's Storey County abatement agreement projections and its compliant five-year audit findings for jobs, hourly wage and capital expenditure, while preserving the state report's duplicate Clark County values as an allocation caution. Hammond includes separate investment, property, employment, financing, supplier, incentive, tax, resource and county-industry evidence plus an unresolved acquisition path for quarterly local-labor records. All 36 candidates retain gaps in complete annual accounts, and no profile yet establishes a complete net community benefit or causal effect.
