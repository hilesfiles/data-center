...
5 September 2026. Companion to the [revised study plan](revised-private-sector-economic-study-plan.md). The application remediation is implemented locally through `private-sector-study-1.42.0`, including browser verification. The release contains 585 source records and 104 separately governed modeled syntheses. Apple Mesa / Maricopa County, Switch Citadel / Storey County and Digital Crossroad Hammond / Lake County pass the machine-enforced full modeled county-account gate. The public deployment has not been changed.
