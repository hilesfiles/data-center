...
6 September 2026. Companion to the [revised study plan](revised-private-sector-economic-study-plan.md). The application remediation is implemented through `private-sector-study-1.51.0`, including browser verification. The release contains 931 source records and 155 separately governed modeled syntheses. Three projects pass the machine-enforced completed-contribution-account gate: Apple Mesa / Maricopa County, Switch Citadel / Storey County, and Digital Crossroad Hammond / Lake County. Batch 6 audits of Google Clarksville, Meta Prineville, and Microsoft Boydton add 133 reported observations and 29 source forecasts after mandatory discovery and gap-closure passes. Six eligible last-resort syntheses were retained; all three remain explicitly incomplete where public evidence cannot defensibly bound material gaps.
...
Study release `private-sector-study-1.51.0` publishes 931 source-checked records across all 36 candidates—826 reported observations and 105 forecasts—plus 155 separately governed syntheses. Twenty-one projects have completed scoped research audits and are map-eligible; the separate full modeled-account gate remains at three. Batch 6 adds 162 source records and six eligible modeled syntheses after mandatory discovery, gap-closure, and metric-specific modeling review. Typed intervals, contribution channels, aggregation controls, named parameter provenance, and causal or multiplier requirements keep models outside canonical claims and realized-benefit totals.
