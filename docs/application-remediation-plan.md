...
Study release `private-sector-study-1.45.0` publishes 647 source-checked records across all 36 candidates—585 reported observations and 62 forecasts—plus 176 separately governed syntheses across six completed accounts. Batch 2 adds 46 reported records, six forecasts, and 22 retained last-resort models after wider tax, assessor, permit, incentive, utility, operator, workforce, procurement, and community-record searches. Expedient Franklin retains seven models and remains open for community and supplier evidence; Google Council Bluffs retains eight and Apple Washoe retains seven, with supplier evidence still unresolved for both. Typed intervals, contribution channels, aggregation controls, named parameter provenance, and causal or multiplier requirements keep models outside canonical claims and realized-benefit totals.
