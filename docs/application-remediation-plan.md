...
6 September 2026. Companion to the [revised study plan](revised-private-sector-economic-study-plan.md). The application remediation is implemented through `private-sector-study-1.52.0`, including browser verification. The release contains 938 source records and 160 separately governed modeled syntheses. Three projects pass the machine-enforced completed-contribution-account gate: Apple Mesa / Maricopa County, Switch Citadel / Storey County, and Digital Crossroad Hammond / Lake County. Corrective model-audit Batch A revisits Meta Eagle Mountain, State Farm Olathe, and Switch Las Vegas NAP7 after the direct-evidence-first contract was strengthened. It adds seven reported observations and five eligible last-resort syntheses; all three remain explicitly incomplete where public evidence cannot defensibly bound material gaps.
...
Study release `private-sector-study-1.52.0` publishes 938 source-checked records across all 36 candidates—833 reported observations and 105 forecasts—plus 160 separately governed syntheses. Twenty-one projects have completed scoped research audits and are map-eligible; the separate full modeled-account gate remains at three. Corrective model-audit Batch A adds seven reported observations and five eligible syntheses after renewed direct-source discovery and candidate-by-candidate modeling review. Eagle Mountain adds six observations and rejects every model candidate; Olathe adds one observation and four bounded syntheses; NAP7 adds one public-service-cost break-even synthesis without asserting cash payment, service cost, or net benefit. Typed intervals, contribution channels, aggregation controls, named parameter provenance, and causal or multiplier requirements keep models outside canonical claims and realized-benefit totals.
