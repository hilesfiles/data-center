...
Study release `private-sector-study-1.49.0` publishes 718 source-checked records across all 36 candidates—648 reported observations and 70 forecasts—plus 149 separately governed syntheses. Fifteen projects have completed scoped research audits and are map-eligible; the separate full modeled-account gate remains at three. Batch 4 adds 26 source records and only three eligible descriptive syntheses after persistent project-specific source review. Typed intervals, contribution channels, aggregation controls, named parameter provenance, and causal or multiplier requirements keep models outside canonical claims and realized-benefit totals.
