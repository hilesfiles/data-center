...
6 September 2026. Companion to the [revised study plan](revised-private-sector-economic-study-plan.md). The application remediation is implemented through `private-sector-study-1.44.0`, including browser verification. The release contains 595 source records and 154 separately governed modeled syntheses. Apple Mesa / Maricopa County, Switch Citadel / Storey County, Digital Crossroad Hammond / Lake County, Meta Forest City / Rutherford County, Microsoft San Antonio / Bexar County, and EdgeConneX DET01 / Oakland County pass the machine-enforced completed-contribution-account gate. Fiscal presentation reports recurring local tax contributions and public-cost break-even thresholds only where same-scope evidence supports them, without claiming an unsupported net result; county comparison gaps are explicitly noncausal.
...
Study release `private-sector-study-1.44.0` publishes 595 source-checked records across all 36 candidates—539 reported observations and 56 forecasts—plus 154 separately governed syntheses across six completed accounts. Batch 1 adds Meta Forest City (one reported record and 16 models), Microsoft San Antonio (three reported records, four forecasts, and 11 models), and EdgeConneX DET01 (two reported records and 23 models). The accounts cover bounded construction and operating contribution channels, fiscal evidence and break-even thresholds where available, resource engineering and explicitly noncausal county comparisons. Typed intervals, contribution channels, aggregation controls, named parameter provenance and causal or multiplier requirements keep models outside canonical claims and realized-benefit totals.
