...
Study release `private-sector-study-1.37.0` publishes 560 source-checked records across all 36 candidates: 512 reported observations and 48 forecasts. The depth accounts now include Meta Forest City, Digital Crossroad Hammond and Switch Citadel. The Storey account adds the core Citadel parcel's 2024–2026 real-property values, three fiscal-year tax bills, two completed payments, one current partial-year payment, two Fire District contribution reports and the district's paired equipment-cost forecast. Nevada's agreement audit remains at company-county scope with the duplicate Clark County values disclosed as an allocation caution. All 36 candidates retain gaps in complete annual accounts, and no profile yet establishes a complete net community benefit or causal effect.
